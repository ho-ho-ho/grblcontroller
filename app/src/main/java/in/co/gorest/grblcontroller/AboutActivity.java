...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setSubtitle(getString(R.string.text_app_about));
        }
        getSupportFragmentManager().beginTransaction()
                .replace(android.R.id.content, new AppAboutFragment()).commit();
    }
    ...
    public static class AppAboutFragment extends PreferenceFragmentCompat {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (this.hasPaidVersion()) {
                getPreferenceScreen().removePreference(
                        Objects.requireNonNull(findPreference("buy_grbl_controller_plus")));
            }
        ...
        public boolean hasPaidVersion() {
            ...
            try {
                pm.getPackageInfo("in.co.gorest.grblcontroller.plus",
