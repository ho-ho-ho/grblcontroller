...
public class GrblUsbSerialService extends Service {
     ...
     */
    private final UsbSerialInterface.UsbCTSCallback ctsCallback =
     ...
     */
    private final UsbSerialInterface.UsbDSRCallback dsrCallback =
    ...
    private void findSerialPortDevice() {
        ...
        try {
            ...
            if (!usbDevices.isEmpty()) {
                ...
                if (!keep) {
                    // There is no USB devices connected (but usb host were listed). Send an
        ...
        public void run() {
            ...
            if (serialPort != null) {
                if (serialPort.open()) {
                    ...
                    // know whether a new sketch is going
