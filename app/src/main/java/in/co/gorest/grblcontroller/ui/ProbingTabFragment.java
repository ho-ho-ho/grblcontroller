...
public class ProbingTabFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        probingTabLayout.addTab(probingTabLayout.newTab().setText("Straight"));
        probingTabLayout.addTab(probingTabLayout.newTab().setText("TLO"));
        probingTabLayout.addTab(probingTabLayout.newTab().setText("Center"));
