...
public class MachineStatusListener extends BaseObservable {
  ...
  private MachineStatusListener() {
    ...
    this.compileTimeOptions = new CompileTimeOptions(emptyString, Constants.DEFAULT_PLANNER_BUFFER,
        Constants.DEFAULT_SERIAL_RX_BUFFER);
    this.parserState = new ParserState("G0 G54 G17 G21 G90 G94");
  }

  @Bindable
  public String getCustomStartUpString() {
    return this.customStartUpString;
  }
  ...
  @Bindable
  public Boolean getIgnoreError20() {
    return this.ignoreError20;
  }
  ...
  @Bindable
  public Boolean getLaserModeEnabled() {
    return this.laserModeEnabled;
  }
  ...
  @Bindable
  public Integer getSerialRxBuffer() {
    return this.serialRxBuffer;
  }
  ...
  @Bindable
  public Position getLastProbePosition() {
    return this.lastProbePosition;
  }
  ...
  @Bindable
  public Double getToolLengthOffset() {
  ...
  @Bindable
  public Position getWorkCoordsOffset() {
    return this.workCoordsOffset;
  }
  ...
  @Bindable
  public OverridePercents getOverridePercents() {
    return this.overridePercents;
  }
  ...
  @Bindable
  public CompileTimeOptions getCompileTimeOptions() {
    return this.compileTimeOptions;
  }
  ...
  public static class EnabledPins {
    ...
    public boolean hasChanged(EnabledPins enabledPins) {
      ...
      return (xChanged || yChanged || zChanged || probeChanged || doorChanged || holdChanged
          || softResetChanged || cycleStartChanged);
    }
