...
public class SimpleGcodeMaker {
    ...
    public String cutCcw(double dist) {
        String s = "(cut ccw)\n";
        s += "G01 X" + (this.xf + dist) + " Y" + (this.yf - dist) + "\n";
        s += "Y" + (this.yt + dist) + "\n";
        s += "X" + (this.xt - dist) + "\n";
        s += "Y" + (this.yf - dist) + "\n";
        s += "X" + (this.xf + dist) + "\n";
    ...
    public String CorneringCut(double tool_radius) {//tr tool radius
        ...
        s += "G01 X" + this.xf + " Y" + (this.yf + tool_radius) + "\n";//start
        s += ("G01 X" + this.xt + "\n");//1seg
        s += ("G02 X" + (this.xt + tool_radius) + " Y" + this.yf + " I0.000 J-" + tool_radius + "\n");//1arc
        s += ("G01 Y" + this.yt + "\n");//2seg
        s += ("G02 X" + this.xt + " Y" + (this.yt - tool_radius) + " I-" + tool_radius + " J0.0000\n");//2arc
        s += ("G01 X" + this.xf + "\n");//3seg
        s += ("G02 X" + (this.xf - tool_radius) + " Y" + this.yt + " I0.000 J" + tool_radius + "\n");//3arc
        s += ("G01 Y" + this.yf + "\n");//4seg
        s += ("G02 X" + this.xf +  "Y" + (this.yf + tool_radius) + " I" + tool_radius + " J0.0000\n");//4arc
    ...
    public String circleCut(double offset, boolean aprox_pass) {
        ...
        for (int i = 0; i < npass; i++) {
            o = offset * i;
            s += "G01 X" + (quadR - o) + " Y" + this.ycenter + "\n";
            s += "G02 X" + (quadL + o) + " I-" + (this.ray - o) + " J0.0\n";
