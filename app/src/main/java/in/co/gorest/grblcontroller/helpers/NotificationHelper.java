...
public class NotificationHelper extends ContextWrapper {
    ...
    public static final String CHANNEL_GENERAL_ABOUT =
            "application specific news, features and updates information.";

    public static final String CHANNEL_BUG_TRACKER_ID =
            "in.co.gorest.grblcontroller.BUG_TRACKER_SERVICE";
    public static final String CHANNEL_BUG_TRACKER_NAME = "BugTracker";
    public static final String CHANNEL_BUG_TRACKER_ABOUT =
            "notifications about recent application bugs, issues and resolutions.";

    public static final String CHANNEL_SERVICE_ID =
            "in.co.gorest.grblcontroller.APPLICATION_SERVICE";
    public static final String CHANNEL_SERVICE_NAME = "Service";
    public static final String CHANNEL_SERVICE_ABOUT =
            "Service notification when app is working in foreground.";
    ...
    public void createChannels() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel mChannelOne = new NotificationChannel(CHANNEL_GENERAL_ID,
                    CHANNEL_GENERAL_NAME, NotificationManager.IMPORTANCE_DEFAULT);
            ...
            NotificationChannel mChannelTwo = new NotificationChannel(CHANNEL_BUG_TRACKER_ID,
                    CHANNEL_BUG_TRACKER_NAME, NotificationManager.IMPORTANCE_HIGH);
            ...
            NotificationChannel mChannelThree = new NotificationChannel(CHANNEL_SERVICE_ID,
                    CHANNEL_SERVICE_NAME, NotificationManager.IMPORTANCE_DEFAULT);
    ...
    public void getNotificationGeneral(String title, String message, PendingIntent pendingIntent) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(
                getApplicationContext(), CHANNEL_GENERAL_ID)
    ...
    public void getNotificationBugTracker(String title, String message,
            PendingIntent pendingIntent) {

        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(
                getApplicationContext(), CHANNEL_BUG_TRACKER_ID)
                .setContentTitle(title)
                //.setContentText(message)
                .setStyle(new NotificationCompat.BigTextStyle().bigText(message))
                .setSmallIcon(R.drawable.ic_stat_ic_notification)
